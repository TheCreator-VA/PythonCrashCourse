...
#  and could be several words long. For example, "123 Main Street", "1001 1st Ave",
#  or "55 North Center Drive". Fill in the gaps to complete this function.

def format_address(address_string):
    h_no = address_string[:address_string.index(" ")]
    locality = address_string[address_string.index(' '):]


    return "house number {} on street named {}".format(h_no,locality)
